...
#'               correctedPval  = 1
#'               )
#' @export comorbidityAnalysisTest

comorbidityAnalysisTest <- function ( input, codesPth, databasePth, ageRange=c(0,100), sex="ALL", score, correctedPval = 1, correctionMethod = "fdr", oddsRatio, rr, phi, cores = 1, verbose = FALSE, warnings = TRUE ){
