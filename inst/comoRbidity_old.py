...
if __name__ == '__main__':
    ...
    """
    bar = "\\"
    if "/" in PATIENT_FOLDER_PATH:
        bar = "/"
        
    if PATIENT_FOLDER_PATH[-1] != bar:
        PATIENT_FOLDER_PATH += bar
    
        
    admis_data_path =PATIENT_FOLDER_PATH + "admissionData.txt"
    codes_path =CODES_FOLDER_PATH +  "indexDiseaseCodesAgg.txt"
    diag_data_path =PATIENT_FOLDER_PATH + "diagnosisData.txt"
    patient_data_path = PATIENT_FOLDER_PATH + "patientData.txt"
    """
    admis_data_path ="/home/alba/Desktop/" + "admissionData.txt"
    codes_path ="/home/alba/Desktop/" +  "indexDiseaseCodesAgg.txt"
    diag_data_path ="/home/alba/Desktop/" + "diagnosisData.txt"
    patient_data_path = "/home/alba/Desktop/" + "patientData.txt"
    sep_admis_date = "-"
    sep_birth_date = "-"
    
    #run(admis_data_path, codes_path, diag_data_path, patient_data_path, sep_admis_date, sep_birth_date, PATIENT_FOLDER_PATH, first_admin_date)
    run(admis_data_path, codes_path, diag_data_path, patient_data_path, sep_admis_date, sep_birth_date, "/home/alba/Desktop/", first_admin_date)
